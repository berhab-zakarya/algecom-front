...
export function DashboardContent() {
  return (
    <div className="ml-64 p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-primary-900 text-lg font-semibold mb-4">Total Income</CardTitle>
            ...
            <div className="mt-4">
              <div>
                <div className="flex items-baseline mb-2">
                  <span className="text-primary-900 text-3xl font-bold">50,530.00</span>
              ...
              <div className="mb-4">
                <p className="text-sm mt-2">
                  ...
                  <span className="text-neutral-500"> increase compared to last week</span>
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-primary-900 text-lg font-semibold mb-4">Total Expense</CardTitle>
          ...
          <CardContent>
            <div className="mt-4">
              <div>
                <div className="flex items-baseline mb-2">
                  <span className="text-primary-900 text-3xl font-bold">19,760.00</span>
                  <span className="text-neutral-500 text-xl ml-2">(DZD)</span>
                </div>
              </div>
              <div className="mb-4">
                <p className="text-sm mt-2">
                  ...
                  <span className="text-neutral-500"> decrease compared to last week</span>
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            <div className="flex justify-between items-center pb-2">
              <h1 className="text-primary-900 text-lg font-semibold">Your balance</h1>
              <Button variant="ghost" size="icon" className="text-primary-900">
      ...
      {/* Charts row - Statistics and Donut */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Spending Statistics with adjusted height */}
        <Card>
          <CardContent className="p-6">
            <SpendingStatistics 
              ...
              className="h-[400px]" // Control height
            />
          </CardContent>
        </Card>

        {/* Spending Donut with matching height */}
        <Card>
          <CardContent className="p-6">
            <SpendingDonut />
          </CardContent>
