      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="border rounded-xl p-6 flex flex-col h-full">
            ...
            <Button title="Subscribe" className="w-full bg-purple-800 hover:bg-purple-900"onClick={()=>{} }/>
          </div>
          ...
          <div className="border rounded-xl p-6 flex flex-col h-full">
            ...
            <Button title="Subscribe" className="w-full bg-purple-800 hover:bg-purple-900"onClick={()=>{} }></Button>
          </div>
